...
public data class TextRange(val start: Int, val endExclusive: Int) {
     ...
     */
    public fun shift(value: Int): TextRange = TextRange(start + value, endExclusive + value)
     ...
     */
    public fun substring(text: String): String = text.substring(start, min(endExclusive, text.length))
    ...
    public operator fun contains(position: Int): Boolean {
    ...
    public operator fun contains(range: TextRange): Boolean {
     ...
     */
    public fun covers(other: TextRange): Boolean {
     ...
     */
    public fun subtract(other: TextRange): Array<TextRange> {
    ...
    public companion object {
         ...
         */
        public operator fun invoke(range: IntRange): TextRange = TextRange(range.start, range.endInclusive + 1)
         ...
         */
        public fun covering(ranges: Array<TextRange>): TextRange? {
